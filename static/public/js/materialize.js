...
Vel = $ ? $.Velocity : Velocity,
    ...
    function(a) {
        a.fn.tooltip = function(b) {
            ...
            b = a.extend(g, b);
            var h = this;
            return a(".material-tooltip").each(function(b, c) {
                var d = a(c).data("origin");
                jQuery.contains(document, d[0]) ? h.filter(d).length && a(c).remove() : a(c).remove()
            }), this.each(function() {
                var g = a(this),
        ...
        a(document).ready(function() {
            ...
            a(e).each(function() {
                ...
                a(this).find('input[type="file"]').change(function() {
                    for (var c = a(this)[0].files, d = [], e = 0; e < c.length; e++) d.push(c[e].name);
                    b.val(d.join(", ")), b.trigger("change")
                })
            });
